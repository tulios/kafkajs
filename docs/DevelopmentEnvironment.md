...
```sh
COMPOSE_FILE="docker-compose.0_11.yml" ./scripts/dockerComposeUp.sh
```

If you run `docker-compose -f docker-compose.0_11.yml ps` (specify whichever compose file you used in the step above), you should see something like:

```sh
$ docker-compose -f docker-compose.0_11.yml ps
